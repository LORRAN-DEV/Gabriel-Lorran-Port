...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const translations = {
        pt: {
            ...
            projeto_descricao_1: "API REST em Spring Boot + MySQL + Docker para: Cadastro de usuários. Autenticação de usuários via Spring Security.Cadastro de produtos. Geração e gestão de vouchers. Documentação via Swagger.",
            projeto_tag_1.1: "JAVA",
            projeto_tag_1.2:"DOCKER",
            projeto_tag_1.3:"SPRING",
            projeto_tag_1.4:"MySQL",
            projeto_titulo_2: "Encurtador de URL",
            projeto_descricao_2: "Este é um projeto de encurtador de URLs simples, desenvolvido em PHP + MySQL, permitindo gerar links curtos para URLs longas e realizar o redirecionamento automaticamente. O projeto é ideal para estudo e prática de PHP, MySQL, organização de código e conceitos de URL.",
            projeto_tag_2.1: "PHP",
            projeto_tag_2.2: "MySQL",
        ...
        en: {
            ...
            cert_excel: "JavaScript: Fundamentals for Interactive Web Development",
            cert_python: "Database Administrator",
            cert_python_2: "Artificial Intelligence for Sustainable Projects",
